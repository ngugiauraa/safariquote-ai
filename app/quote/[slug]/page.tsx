  ...
  const handleSubmit = async () => {
    ...
    setTimeout(() => {
      const mockQuote = {
        ...
        itinerary: "Based on your selections: Wildlife Safari, Cultural Experiences, Luxury Accommodation, Private 4x4 transport.",
        pricingBreakdown: {
          transport: 140000,
          hotels: 210000,
          activities: 65000,
        ...
        top3Hotels: [
          { name: "Mara Serena Safari Lodge", reason: "Prime location with great views" },
          { name: "Ashnil Mara Camp", reason: "Luxury tents and excellent service" },
          { name: "Mara Intrepids", reason: "Family-friendly with good facilities" }
        ],
        notes: "This is a mock quote. When you add xAI credits, this will be generated by Grok AI with real routing and pricing."
      };
      setQuote(mockQuote);
